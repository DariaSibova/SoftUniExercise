const motorcycleRider = {
    licenseRestriction(category) {
      if (category === "AM") {
        ...
        return 'Motorcycles whit maximum power of 35KW. and the minimum age is 18.'
      } else if (category === "A") {
    ...
    otherSpendings(equipment, consumables, discount) {
      ...
      if (discount) {
        ...
        return `You spend $${totalPrice.toFixed(2)} for equipment and consumables whit 10% discount!`
      } else {
